(() => {
  ...
  window.ZZZ_PLANNER_LOCALES.ru = Object.freeze({
      ...
      baseRate: 'базовый шанс', guaranteedBy: 'S-ранг гарантирован на', softPity: 'софт-пити с', featuredAgentRate: 'выбранный агент', featuredWEngineRate: 'выбранный амплификатор', independentPity: 'Счётчик отдельный от других каналов', dateTbd: 'Пока неизвестно', unconfirmed: 'Не подтверждено', provisional: 'Своя цель', moveUp: 'Переместить выше', moveDown: 'Переместить ниже', daysLeft: 'дней осталось', searchesPerDay: 'крутки/день',
      ...
      selectedTarget: 'Цель', chanceNow: 'С текущим балансом', notAvailableNowShort: '(N/A)', futureBalanceTooltip: 'Канал этой цели ещё не начался. Шанс рассчитан только по текущему балансу.', futureSummaryBalanceTooltip: 'Каналы некоторых выбранных целей ещё не начались. Шанс рассчитан только по текущему балансу.', byDeadline: 'Получить к сроку', missByDeadline: 'Не получить к сроку',
