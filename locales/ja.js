(() => {
  ...
  window.ZZZ_PLANNER_LOCALES.ja = Object.freeze({
      ...
      exportHistory: '履歴を書き出す', importHistory: '履歴を読み込む', trackedTotal: '記録期間の合計', trackedSevenDays: '直近7日間の記録分', trackedThirtyDays: '直近30日間の記録分', trackedDailyAverage: '1日あたりの平均',
      ...
      guaranteeStatus: '確定排出状況', searchRules: '変調ルール', agentTargets: '狙うエージェント', target: '目標', agentTarget: 'エージェント目標', wEngineTarget: '音動機目標', agentTargetShort: 'エージェント', agentMindscapeTargetShort: 'エージェント / M', mindscape: '心象映画', wEngineTargetShort: '音動機', priority: '優先順位', agent: 'エージェント', actions: '操作',
      ...
      maxAgentsReached: 'エージェントは最大{limit}人まで登録できます。', maxTargetsReached: '計算対象は最大15件まで選択できます。', mindscapeHelp: 'エージェントの1体目はM0、追加分はM1～M6を選びます。必要な分はすべて連続して変調し、エージェント全体で計算目標15件のうち1件として数えます。', removeProvisionalConfirm: '「{name}」をプランナーから削除しますか？',
