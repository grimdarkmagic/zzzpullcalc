(() => {
  ...
  window.ZZZ_PLANNER_LOCALES.ja = Object.freeze({
      ...
      guaranteeStatus: '確定排出状況', searchRules: '変調ルール', agentTargets: '狙うエージェント', target: '目標', agentTarget: 'エージェント目標', wEngineTarget: '音動機目標', agentTargetShort: 'エージェント', wEngineTargetShort: '音動機', priority: '優先順位', agent: 'エージェント', actions: '操作',
      ...
      maxAgentsReached: 'エージェントは最大{limit}人まで登録できます。', maxTargetsReached: '計算対象は最大15件まで選択できます。', removeProvisionalConfirm: '「{name}」をプランナーから削除しますか？',
