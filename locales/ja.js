(() => {
  ...
  window.ZZZ_PLANNER_LOCALES.ja = Object.freeze({
      ...
      chartCumulativeTitle: '累積した獲得と使用', chartCumulativeHelp: '累積獲得数と累積使用数を、記録時の所持数と比較します。', chartIntervalsTitle: '期間ごとの獲得と使用', chartIntervalsHelp: '棒の各組は、その記録日時までの期間を表します。', chartWalletTitle: '所持リソースの内訳', chartWalletHelp: '記録されたモノクローム、ポリクローム、暗号化マスターテープを変調回数分に換算しています。',
      chartEarned: '獲得', chartSpent: '使用', chartWalletBalance: '所持数', chartDate: '日付', chartPulls: '変調回数分', chartPeriodDays: '日数', chartClosingBalance: '終了時の所持数', chartIntervalDetails: '期間の詳細', chartLatestIntervals: '全{total}期間のうち直近{count}期間を表示しています。', chartNoIntervals: '期間を作成するには、もう1件記録してください。',
