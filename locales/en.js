(() => {
  ...
  window.ZZZ_PLANNER_LOCALES.en = Object.freeze({
      ...
      selectedTarget: 'Selected target', chanceNow: 'With current balance', notAvailableNowShort: '(N/A)', futureBalanceTooltip: 'This target’s Channel has not started yet. The probability uses only your current balance.', futureSummaryBalanceTooltip: 'Some selected targets’ Channels have not started yet. The probability uses only your current balance.', byDeadline: 'Obtain by deadline', missByDeadline: 'Miss by deadline',
