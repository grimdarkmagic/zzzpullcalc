    ...
    channels: [
      {
        ...
        agents: [
          ...
          { id: 'phoenix', name: 'Phoenix', nameKey: 'agentNamePhoenix', enabled: true, priority: 10, confirmed: false, showUnconfirmedBadge: false, startDate: '2026-10-21', endDate: '2026-11-11', budget: { periodId: 'phoenix-end', phase: 3 } },
          { id: 'severian', name: 'Severian', nameKey: 'agentNameSeverian', enabled: true, priority: 11, confirmed: false, showUnconfirmedBadge: false, startDate: '2026-11-11', endDate: '2026-12-02', budget: { periodId: 'severian-end', phase: 4 } }
        ]
      },
      {
